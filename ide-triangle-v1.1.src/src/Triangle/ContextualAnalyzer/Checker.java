...
public final class Checker implements Visitor {
    ...
    public Object visitCharacterCommand(CharacterCommand ast, Object o) {
        if (!o.equals(null)) {
            ...
            TypeDenoter eType = (TypeDenoter) myTuple.x;
            ...
            //A�adir el identificador: ast.IL.spelling
            if (literalTable.enter(ast.CL.spelling))//true est� en la tabla
            {
    ...
    public Object visitIntegerCommand(IntegerCommand ast, Object o) {
        if (!o.equals(null)) {
            ...
            //A�adir el identificador: ast.IL.spelling
            if (literalTable.enter(ast.IL.spelling))//true est� en la tabla
            {
                reporter.reportError("identifier \"%\" already declared",
    ...
    public Object visitSelectCommand(SelectCommand ast, Object o) {
        ...
        ast.C.visit(this, new Tuple(eType, ast.E.position));
        literalTable.closeScope();
        return null;
    }

    public Object visitSequentialCase(SequentialCase ast, Object o) {
        ast.C1.visit(this, o);//Case Command
        ast.C2.visit(this, o);//Case Command
        return null;
    }
