...
public final class Encoder implements Visitor {
  ...
  public Object visitEmptyCommand(EmptyCommand ast, Object o) {
    ...
    public Object visitLocalDeclaration(LocalDeclaration ast, Object o) {
        ...
        */
        ...
        extraSize1 = ((Integer) ast.D1.visit(this, frame)).intValue(); // Retorna el espacio extra asignado por declaraciï¿½n
        Frame frame2 =  new Frame(frame, extraSize1); // Saquï¿½ la idea de LetCommand y diapositiva 57 de la presentaciï¿½n del profe.
        extraSize2 = ((Integer) ast.D2.visit(this, frame2)).intValue(); 
        return new Integer(extraSize1 + extraSize2); // Como es una declaraciï¿½n debe retonar el espacio extra asignado por declaraciï¿½n.
  }
    ...
    public Object visitRepeatDoUntilCommand(RepeatDoUntilCommand ast, Object o) {
        ...
        */
        ...
        emit(Machine.JUMPIFop, Machine.falseRep, Machine.CBr, repeatAddr); // Condiciï¿½n false
        return null;
    }
    ...
    /*
        ! obtener valor del lï¿½mite superior, esto es, $Sup
        evaluate [Exp2]
	! obtener el valor inicial de la variable de control, esto es, Id
        evaluate [Exp1]
	! solamente la primera vez saltamos hacia la evaluaciï¿½n de la condiciï¿½n JUMP evalcond
	repetir:	! ejecutar el comando que debe repetirse en cada iteraciï¿½n
        execute [Com]
	! actualizar la variable de control
	! succ incrementa en 1 lo que estï¿½ en la cima de la pila
        CALL succ 
	evalcond:	! evaluar si la variable de control se encuentra dentro de los lï¿½mites
	! cargar simultï¿½neamente Id y $Sup
        LOAD (2) -2 [ST]
	! comparar si el lï¿½mite superior es mayor o igual a la variable de control
        CALL ge
	! seguir con la repeticiï¿½n si la variable de control es menor
        ! o igual que el lï¿½mite superior, de lo contrario salir (seguir hacia abajo)
        JUMPIF (1) repetir
	salir:	! limpiar el espacio de almacenamiento para la variable de
        ! control y el lï¿½mite superior (2 palabras)
        POP 2
         */
    ...
    //Se aï¿½ade visitRepeatUntilCommand
    public Object visitRepeatUntilCommand(RepeatUntilCommand ast, Object o) {
        ...
        */     
        ...
        emit(Machine.JUMPop, 0, Machine.CBr, 0); // Instrucciï¿½n vacï¿½a porque no se conoce h
        repeatAddr = nextInstrAddr; // etiqueta g
        ast.C.visit(this, frame);
        patch(jumpAddr, nextInstrAddr); // En la siguiente direcciï¿½n ya se conoce h entonces se une jumpAddrr y dicha direcciï¿½n.
        ast.E.visit(this, frame); // etiqueta h
        emit(Machine.JUMPIFop, Machine.falseRep, Machine.CBr, repeatAddr); // Como es un until se debe entrar al Comando si la Expresiï¿½n da resultado False.
        return null;      
  ...
  public Object visitAssignDeclaration(AssignDeclaration ast, Object o){
      ...
      */
        ...
        Frame frame = (Frame) o;
        int extraSize = (Integer) ast.E.visit(this, frame); // al visitar la expresion el nivel y tamaï¿½o aumenta
